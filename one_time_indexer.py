...
from info import SESSION, USERBOT_STRING_SESSION, API_ID, API_HASH, BOT_TOKEN, CHANNELS, MOVIE_CHANNEL_ID, SERIES_CHANNEL_ID
    ...
    try:
        for channel in CHANNELS:
            async for user_message in user_bot.get_chat_history(channel):
                ...
                # Save to correct DB based on channel
                await save_file(media, channel_id=channel)
    finally:
        await user_bot.stop()
        await bot.stop()
